    ...
    describe("init()", function () {
      ...
      describe("tokenToEth", async () => {
        ...
        it("Should send less eth after the first trade (tokenToEth() called)", async function () {
          ...
          const ethSent1 = getEthAmount(tx1Receipt);
          const ethSent2 = getEthAmount(tx2Receipt);
          console.log("==============================");
          // console.log(ethers.utils.formatEther(ethSent1));
          console.log(ethSent1);
          console.log("==============================");
          console.log(ethSent2);
          // console.log(ethers.utils.formatEther(ethSent2));
          console.log("==============================");
          expect(ethSent2).below(ethSent1);
        });
      });
